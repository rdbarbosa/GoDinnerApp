...
import { CardItem, Left, Thumbnail, Body, Right, Text, Icon, Card, Button } from "native-base";


const RestaurantCard = ({ name, desc, time = {}, avaliation = 0, thumb, style = {}, onPress, wrapperStyle = {} }) => (
  <Animated.View onPress={onPress} style={{height: 120, ...wrapperStyle}}>
